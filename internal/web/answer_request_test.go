...
func TestBuildAnswerRequestRouterOmitsNativePlugins(t *testing.T) {
	req := buildAnswerRequest("[user]\nhello", "magic", answerRequestTestBody(), agentLedger{}, "router", "", runtimeSettings{}, chathub.FeatureFlags{})
...
func TestBuildAnswerRequestNativeForwardsTools(t *testing.T) {
	req := buildAnswerRequest("[user]\nhello", "magic", answerRequestTestBody(), agentLedger{}, "native", "", runtimeSettings{}, chathub.FeatureFlags{})
...
func TestBuildAnswerRequestAddsCompletedEvidence(t *testing.T) {
	...
	req := buildAnswerRequest("[user]\nsummarize", "magic", answerRequestTestBody(), ledger, "router", "", runtimeSettings{}, chathub.FeatureFlags{})
...
func TestBuildAnswerRequestMCPForwardsTools(t *testing.T) {
	req := buildAnswerRequest("[user]\nhello", "magic", answerRequestTestBody(), agentLedger{}, "router", "http://127.0.0.1:4142/v1/mcp/sse", runtimeSettings{}, chathub.FeatureFlags{})
	if len(req.Tools) != 1 || req.ToolChoice != "auto" {
